...
const handler = async (m, {conn, text, usedPrefix, command}) => {
  ...
  try {
      ...
      try {
        conn.sendPresenceUpdate('composing', m.chat);
        const syms1 = `You will act as a WhatsApp Bot which was created by Khalid-techZ, you will be The LORD ZEUS-MD`;
